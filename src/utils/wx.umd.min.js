          ...
          function t(e, s) {
            ...
            if ("array" == i)
              e.forEach(function(e, n) {
                o.isObject(e) || (n = ""), t(e, s + "%5B" + n + "%5D");
              });
            else if ("object" == i)
              for (var u in e)
                s ? t(e[u], s + "%5B" + a(u) + "%5D") : t(e[u], a(u));
            else r || (n += "&"), (r = !1), (n += s + "=" + a(e));
          }
          var n = "",
            r = !0,
            o = this;
              ...
              [
                {
                  ...
                  value: function(e) {
                    this[e] &&
                      this[e].apply(this, [].splice.call(arguments, 1));
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function(t) {
                    ...
                    if (e) {
                      ...
                      i.merge(o, r._options || {}),
                        "GET" === o.method && (o.body = null),
                        r._changeReadyState(3);
                      var a = void 0;
                      (r.timeout = r.timeout || 0),
                        ...
                        e(o, function(e) {
                          ...
                          if (3 === r.readyState) {
                            clearTimeout(a), (r.status = t("statusCode") - 0);
                            ...
                            if (r.status) {
                              ...
                              u &&
                                ...
                                (r.responseHeaders = c),
                                (r.statusText = o || ""),
                                (r.response = r.responseText = n),
                                (r._response = e),
                                r._changeReadyState(4),
                                r._call("onload");
                            } else
                              (r.statusText = n),
                                r._call("onerror", { msg: o });
                            r._call("onloadend");
                          }
                        });
                ...
                },
                {
                  ...
                  value: function(e) {
                    return (
                      (
                        this.responseHeaders[e.toLowerCase()] || ""
                      ).toString() || null
                    );
                  }
                },
                ...
                value: function(e, t, n) {
                  var r = this,
                    ...
                    d = new Promise(function(c, d) {
                      ...
                      function y(n) {
                        function r(e, t, r) {
                          m(l.p, function() {
                            ...
                            h(t) ||
                              (t = Promise[0 === r ? "resolve" : "reject"](t)),
                              t
                                .then(function(e) {
                                  c(e);
                                })
                        ...
                        var x = s.trim(n.responseType || ""),
                          w =
                            -1 !==
                            ["GET", "HEAD", "DELETE", "OPTION"].indexOf(
                              n.method
                            ),
                          j = s.type(t),
                          O = n.params || {};
                        w && "object" === j && (O = s.merge(t, O)),
                          (O = s.formatParams(O));
                        var S = [];
                        O && S.push(O),
                          w && t && "string" === j && S.push(t),
                          S.length > 0 &&
                            (e +=
                              (-1 === e.indexOf("?") ? "?" : "&") +
                              S.join("&")),
                        ...
                        try {
                          (o.withCredentials = !!n.withCredentials),
                            ...
                            "stream" !== x && (o.responseType = x);
                        } catch (e) {}
                        var T = n.headers[i] || n.headers[u],
                          k = "application/x-www-form-urlencoded";
                        s.trim((T || "").toLowerCase()) === k
                          ? (t = s.formatParams(t))
                          : s.isFormData(t) ||
                            -1 === ["object", "array"].indexOf(s.type(t)) ||
                            ((k = "application/json;charset=utf-8"),
                            (t = JSON.stringify(t))),
                          T || w || (n.headers[i] = k);
                        for (var R in n.headers)
                          if (R === i && s.isFormData(t)) delete n.headers[R];
                          else
                            try {
                      ...
                      s.isObject(e) && ((n = e), (e = n.url)),
                        (n = n || {}),
                        (n.headers = n.headers || {}),
                        m(f.p, function() {
                          s.merge(n, JSON.parse(JSON.stringify(r.config)));
                          var o = n.headers;
                          (o[i] = o[i] || o[u] || ""),
                            delete o[u],
                            (n.body = t || n.body),
                            ...
                            (n.url = e);
                          var a = n;
                          p && (a = p.call(f, n, Promise) || n),
                            h(a) || (a = Promise.resolve(a)),
                            a.then(
                              function(e) {
                                e === n ? y(e) : c(e);
                              },
      ...
      (i.default = i),
        ["get", "post", "put", "patch", "head", "delete"].forEach(function(e) {
          i.prototype[e] = function(t, n, r) {
            return this.request(t, n, s.merge({ method: e }, r));
          };
        }),
